...
import { Trash2, Upload, Image as ImageIcon, ExternalLink } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Upload and manage gallery images shown on the public site
          </p>
        </div>
        <a
          href="/gallery"
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-kaboss-50 dark:bg-kaboss-500/10 text-kaboss-700 dark:text-kaboss-300 text-sm font-medium hover:bg-kaboss-100 dark:hover:bg-kaboss-500/20 transition-colors"
        >
          <ExternalLink className="h-4 w-4" /> View public gallery
        </a>
      </div>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          ...
          />
          <Button onClick={upload} disabled={!files.length}>
